...
nmf_grid = nimfa.Lsnmf.estimate_rank(mod, rank_range=np.arange(2, 20), what=['cophenetic', 'rss'], n_run=10)


fig = plt.figure(figsize=(8,6))
fig_plt = sns.barplot(x=np.arange(2,20), y=[i['cophenetic'] for i in nmf_grid.values()])
fig_plt.set_xlabel("N-Components")
fig_plt.set_ylabel("Cophenetic")
fig_plt.set_title('Cophenetic Score vs. N-Components')
print(fig_plt)
...
fig = plt.figure(figsize=(8,6))
fig_plt = sns.barplot(x=np.arange(2,20), y=[i['rss'] for i in nmf_grid.values()])
fig_plt.set_xlabel("N-Components")
fig_plt.set_ylabel("RSS")
fig_plt.set_title('RSS vs. N-Components')
print(fig_plt)
